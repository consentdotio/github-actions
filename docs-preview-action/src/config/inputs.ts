/**
 * Configuration and input resolution for the docs preview GitHub Action.
 *
 ...
 * "your-org" to ensure we always match that user's comments.
 */
...
export const docsTemplateRepo = core.getInput('docs_template_repo', {
	required: false,
});
...
export const commentMarkerPrefix =
	core.getInput('comment_marker_prefix', { required: false }) || 'action';
export const firstContributorTitle = core.getInput('first_contributor_title', {
	required: false,
});
export const firstContributorMessage = core.getInput('first_contributor_message', {
	required: false,
});
export const firstContributorAuthor = core.getInput('first_contributor_author', {
	required: false,
});
export const shareTextTemplate = core.getInput('share_text_template', {
	required: false,
});
export const shareUrlDefault = core.getInput('share_url_default', {
	required: false,
});
export const docsUrl = core.getInput('docs_url', { required: false });
export const communityUrl = core.getInput('community_url', { required: false });
export const twitterHandle = core.getInput('twitter_handle', { required: false });
export const footerText = core.getInput('footer_text', { required: false });
